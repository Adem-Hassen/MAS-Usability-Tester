...
class DOMState:
    ...
    def to_prompt_string(self) -> str:
        ...
        if self.alert_text:
            lines.append(f"WARNING - ALERT DIALOG: {self.alert_text}")
        if self.has_modal:
            lines.append("WARNING - A modal/dialog is visible")
...
class PlaywrightEngine:
    ...
    def open(self, sandbox_path: str) -> None:
        ...
        logger.info("browser.opened", persona_id=self.persona_id, title=self._page.title())
